...
"symbol": "ESHIP",
"website_slug": "eliteshippertoken"
},
{
"id": 3240,
"name": "Ethersocial",
...
export function filterCurrencyList(event){
  var updatedList = this.state.currencies;
  updatedList = updatedList.filter(function(item){
    return item.name.toLowerCase().search(
      event.target.value.toLowerCase()) !== -1;
  });
  this.setState({filteredCurrencies: updatedList});
}

export function handlSetCurrency(props) {
  this.setState({ selectedCurrency: props })
}
